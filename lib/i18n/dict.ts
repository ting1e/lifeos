...
const en = {
  ...
  "proj.future": "FUTURE",
  "proj.days": "{days}D",
  "proj.inDays": "IN {days}D",
  "proj.deficit": "DEFICIT",
  "proj.deficitUnit": "kcal/day",
  "proj.targetReached": "{kg} kg target reached at day {day}",
  "proj.targetReachedAlready": "{kg} kg target already reached",
  "proj.targetNotReached": "target {kg} kg not reached within {days} days",
  "proj.needProfile":
    "Set profile (sex, height, age, weight) + a daily kcal target to see the projection.",
  "proj.standardIntake": "INTAKE",
  "proj.weeklyTrend": "HIST TREND",
  "proj.perWeek": "kg/wk",
  "proj.recent7Avg": "RECENT 7D",
  "proj.needMoreData": "Need more days of weight data for trend.",
...
const tr: Record<DictKey, string> = {
  ...
  "proj.now": "ŞİMDİ",
  "proj.start": "BAŞLANGIÇ",
  "proj.history": "GEÇMİŞ",
  "proj.future": "GELECEK",
  "proj.days": "{days}G",
  "proj.inDays": "{days}G SONRA",
  "proj.deficit": "AÇIK",
  "proj.deficitUnit": "kcal/gün",
  "proj.targetReached": "{kg} kg hedefine {day}. günde ulaşılır",
  "proj.targetReachedAlready": "{kg} kg hedefine zaten ulaşıldı",
  "proj.targetNotReached": "{days} gün içinde {kg} kg hedefine ulaşılmıyor",
  "proj.needProfile":
    "Projeksiyon için profilini doldur (cinsiyet, boy, yaş, kilo) + günlük kcal hedefi.",
  "proj.standardIntake": "ALIM",
  "proj.weeklyTrend": "TARİHSEL TREND",
  "proj.perWeek": "kg/hafta",
  "proj.recent7Avg": "SON 7G",
  "proj.needMoreData": "Trend için daha fazla kilo kaydı gerekli.",
...
const zh: Record<DictKey, string> = {
  ...
  "proj.targetReached": "目标 {kg} kg 在第 {day} 天达成",
  "proj.targetReachedAlready": "目标 {kg} kg 已达成",
  "proj.targetNotReached": "{days} 天内未达到 {kg} kg 目标",
  "proj.needProfile":
    "完善个人资料（性别、身高、年龄、体重）+ 每日卡路里目标以查看预测。",
  "proj.standardIntake": "标准摄入",
  "proj.weeklyTrend": "历史趋势",
  "proj.perWeek": "kg/周",
  "proj.recent7Avg": "近7日均",
  "proj.needMoreData": "需要更多天的体重记录才能计算趋势。",
